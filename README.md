...
💼 *FOSSEE Intern @ IIT Bombay (Remote)*  
...
- Completed projects:
  - 🔸 *DC–DC Voltage Multiplier (Dickson Charge Pump)*  
  - 🔸 *Low-Voltage Cross-Coupled Charge Pump*  
  - 🔸 *Six-Stage Linear CMOS Charge Pump*
...
📍 *Holy Angel’s Matric Higher Secondary School (2023 – 2024)* – *Scored 95%*

---

## 💼 Projects & Research Contributions

### 🔹 Electronic Voting System (Xilinx Vivado)
...
### 🔹 Adaptive Vision (IoT + AI Project)
- Built smart lighting control system with **motion** & **rain sensors**.
- 🏆 *Won Special Prize at SelfE Hackathon 2024*.

### 🔹 Research Migration Projects (FOSSEE – IIT Bombay)
...
- 🎓 *FOSSEE Internship @ IIT Bombay (eSim Initiative) – 2025*  
- 🏆 *Special Prize – SelfE Hackathon 2024*  
- 💻 *Top 3rd Performer – Skillrack Platform (2024–2025)*  
- ⚙️ *Simulathon 2025 Participant (Proteus Simulation)*  
- 🌍 *Finalist – Google Developer Group Solution Challenge 2025*  
- 🥉 *Freshwarite 2024 – 3rd Position*  
- 🔥 *CodeChef Gold Streak Badge (50-day streak)*  
...
### ⚙️ Interests
VLSI • RTL Design • FPGA Systems • CMOS Circuits • Embedded Hardware • Open-Source EDA Tools  
